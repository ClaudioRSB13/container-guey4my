...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-guey4my.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-guey4my.containers.anotherwebservice.com/
...
```
git clone git@github.com:ClaudioRSB13/container-guey4my.git
cd container-guey4my
```
...
```
docker attach container-guey4my
```
